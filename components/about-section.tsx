...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="py-20 bg-gradient-to-b from-white to-muted/20 overflow-hidden"
      ref={ref}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="bg-white/50 backdrop-blur-sm rounded-xl p-8 shadow-lg">
              ...
              >
                Under the visionary leadership of Mr. Gopal Dhungel, Om Krishi
                Machinery has grown to become a trusted name in Nepal's
                agricultural and industrial equipment sector. Our commitment to
                quality and customer satisfaction has made us the preferred
                choice for farmers and professionals across the country.
              </motion.p>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <p className="text-muted-foreground">
                    To empower Nepal's agricultural and industrial sectors by
                    providing reliable machinery, expert services, and
