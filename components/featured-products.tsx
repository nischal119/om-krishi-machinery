...
const chainsaw = productData.find((p) => p.name === "Chainsaw") || productData[1]
const solarInverter = productData.find((p) => p.name === "Solar Inverter") || productData[5]
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Our most popular and high-quality offerings</p>
          </div>
          <Button
            variant="link"
        ...
        <div className="mt-16 bg-muted rounded-lg p-8 text-center">
          <h3 className="text-2xl font-bold mb-3">Need Help Finding the Right Product?</h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Our experts can help you choose the perfect equipment for your specific agricultural needs. Get personalized
            recommendations based on your farm size, crop type, and budget.
          </p>
          <Button
            size="lg"
            onClick={() => {
              toast.info("Please contact us using the form below for personalized recommendations.")
